...
const categoryContent = document.getElementById("category_content") as HTMLDivElement;
const categoriesContent = document.getElementById( "categories_content") as HTMLDivElement;
const showCategories = document.getElementById( "show_categories") as HTMLButtonElement;
const main = document.getElementById("main") as HTMLDivElement;
const categories = document.getElementById("categoroies") as HTMLDivElement;
      ...
      <div class="flex items-center justify-between gap-3 mt-2">
          <div class="product_price">
            ...
            <span class="text-sm font-normal bg-black px-2 rounded-sm  text-white">In stock:
              <span class="text-base text-green-500 font-bold">${
                product.stock
              }</span>
              </span>
          </div>
